...
/// - <see cref="TestDataFactoryGenerator.TestData.BusinessLogic.Order"/><br/>
/// - <see cref="TestDataFactoryGenerator.TestData.Served.AllCollections"/><br/>
...
internal partial class TdfName
{
        ...
        public TTS1.Delivery GenerateDelivery()
        {
                ...
                return constructorNumber switch {
                        0 => new TTS1.Delivery(
                                Items: [..GetSome(() => GenerateTTS1ItemPosition())],
        ...
        public TTS1.ItemPosition GenerateTTS1ItemPosition(
        ...
        public TTB.ItemPosition GenerateItemPosition(
                Guid? itemPositionId = null,
                Guid? productId = null,
                string? productShortName = null,
                int? count = null,
        ...
        {
                return new TTB.ItemPosition(
                        ItemPositionId: itemPositionId ?? random.NextGuid(),
                        ProductId: productId ?? random.NextGuid(),
                        ProductShortName: productShortName ?? random.NextString(""),
                        Count: count ?? random.Next(),
                        UnitPrice: unitPrice ?? random.NextDecimal());
        }
        ...
        public TTB.Order GenerateOrder(
                Guid? orderId = null,
                IImmutableList<TTB.ItemPosition>? items = null)
        {
                return new TTB.Order(
                        OrderId: orderId ?? random.NextGuid(),
